 ...
 * @Date 2025-10-28 16:11
 * @Version v2.0
 */
public class HBaseDML {

    // 添加静态属性 connection 指向单例连接
    public static Connection connection = HBaseMultiThreadConnect.connection;
    ...
    public static void main(String[] args) throws IOException {
        // 1.插入数据
//        putCell("lrhealth", "person", "1001", "info", "name", "赵子健");
//        putCell("lrhealth", "person", "1002", "info", "name", "徐志德");
//        putCell("lrhealth", "person", "1002", "info", "sex", "男");
//        putCell("lrhealth", "person", "1003", "info", "name", "田飞");
//        putCell("lrhealth", "person", "1004", "info", "name", "郑德琦");
//        putCell("lrhealth", "person", "1005", "info", "name", "白永申");
//        putCell("lrhealth", "person", "1006", "info", "name", "麻一凡");
        // 2.获取数据
        getCells("lrhealth", "person", "1006", "info", "name");
        // 3.带过滤的扫描
//        filterScan("lrhealth", "person", "1001","1010","info", "name", "徐志德");
        // 4.删除 column 数据
//        deleteColumn("lrhealth", "person", "1006", "info", "name");
    }
}
