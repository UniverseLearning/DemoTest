...
public class HBaseDDL {
     ...
     * @return ture 表示存在
     */
    public static boolean isTableExists(String namespace,
     ...
     * @param version      版本
     */
    public static void modifyTable(String namespace,
                                   String tableName,
                                   String columnFamily,
     ...
     * @return true 表示删除成功
     */
    public static boolean deleteTable(String namespace,
                                      String tableName) throws IOException {
        // 1. 判断表格是否存在
        if (!isTableExists(namespace, tableName)) {
    ...
    public static void main(String[] args) throws IOException {
        // 1.创建NameSpace
//        createNamespace("lrhealth");
        // 2.判断Table是否存在
//        boolean tableExists = isTableExists("lrhealth", "person");
//        System.out.println("2.判断Table是否存在: " + tableExists);
        // 3.创建表格
//        createTable("lrhealth", "person", "info", "msg");
        // 4.修改表格中一个列族的版本
//        modifyTable("lrhealth", "person", "info", 2);
    }
